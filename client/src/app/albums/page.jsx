...
} from "@/libs/features/albumSlices";
        ...
        <div className="flex flex-wrap gap-7 justify-center">
          {albums?.map((album) => (
            <div key={album["@key"]} className="relative">
              <Card className=" border-[0.1em] m-auto border-0 rounded-xl h-[15em] w-[12em] bg-[rgba(39,39,39,255)]">
                <AiOutlinePlaySquare
                  size={"xxl"}
                  className=" col-span-3 cursor-pointer mx-2 h-[8em] w-[8em]"
                  onClick={() => {
                    router.push(`/albums/` + album["@key"]);
                  }}
                />
              ...
              <div className="absolute top-0 right-0 mt-2 mr-2">
                ...
                >
                  ...
                  <Dropdown.Item
                    onClick={(e) => deleteAlbum({ id: album["@key"] })}
                  >
                    Delete
                  </Dropdown.Item>
                </Dropdown>
