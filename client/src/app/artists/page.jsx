          ...
          <div className="flex flex-wrap gap-7 justify-center">
            {artists?.map((artist) => (
              <div key={artist["@key"]} className="relative">
                <Card className="rounded-full flex flex-col items-center m-auto bg-[rgba(39,39,39,255)] border-[rgba(255,141,65,255)] border-[0.1em] pt-2 border-0 rounded-none">
                  <Avatar
                    bordered
                    rounded
                    size="lg"
                    ...
                    onClick={() => {
                      router.push(`/artists/` + artist["@key"]);
                    }}
                  />
                ...
                <div className="absolute top-0 right-0 mt-2 mr-2">
                  <Dropdown
                    inline
                    className="bg-[rgba(253,244,236,255)] border-[rgba(255,143,71,255)] h-[5em]"
                  >
                    <Dropdown.Item
                      onClick={(e) =>
                        router.push(`artists/update/` + artist["@key"])
                      }
                    >
                      Update
                    </Dropdown.Item>
                    <Dropdown.Item
                      onClick={(e) => deleteArtist({ id: artist["@key"] })}
                    >
                      Delete
                    </Dropdown.Item>
                  </Dropdown>
